...
class Empty extends TweetSet {
  ...
  def descendingByRetweet: TweetList = Nullable
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def filterAcc(tweet: Tweet => Boolean, tweetSet: TweetSet): TweetSet = {
    if (tweet(elem)) left.filterAcc(tweet, right.filterAcc(tweet, tweetSet.incl(elem)))
    else left.filterAcc(tweet, right.filterAcc(tweet, tweetSet))
  }
  ...
  /**
    ...
    * }
    */
  def union(tweet: TweetSet): TweetSet = {
    if (this.isEmpty) tweet
    else if (tweet.isEmpty) this
    else tweet.filterAcc(_ => true, this)
  }
...
object Nullable extends TweetList {
